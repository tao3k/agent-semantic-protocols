//! Immutable sorted-record table used by resident Search generations.
...
fn encode_record_table_body(
    ...
    records.into_iter().try_fold(
        (Vec::with_capacity(directory_len), Vec::new()),
        |(mut directory, mut payload), (key, value)| {
...
#[cfg(test)]
#[path = "../tests/unit/sorted_record_table.rs"]
mod tests;

#[cfg(test)]
#[path = "../tests/unit/sorted_record_table_integrity.rs"]
mod integrity_tests;

#[cfg(test)]
#[path = "../tests/unit/sorted_record_table_performance.rs"]
