    ...
    let activation = HookActivation {
        ...
        providers: vec![ActivatedProviderConfig {
            ...
            coverage: ActivationCoverage {
                ...
                workspace_source_scope_generation: provider.workspace_source_scope_generation.clone(),
                project_resolutions: provider.project_resolutions.clone(),
            },
        }],
    };
...
fn activated_gerbil_provider(provider_command_prefix: Vec<String>) -> ActivatedProvider {
    ...
    ActivatedProvider {
        ...
        source_paths: vec!["src/main.ss".to_string()],
        repository_candidate_generation: "test-candidate-generation".to_string(),
        workspace_source_scope_generation: "test-project-resolution-generation".to_string(),
        project_resolutions: Vec::new(),
        search_capabilities: manifest.search_capabilities,
