    ...
    asp_rust_project_harness_policy::asp_rust_project_harness_scenario_package!(
        ...
        scenarios: [
            asp_rust_project_harness_policy::asp_rust_project_harness_scenario!(
                ...
                tags: ["hook", "shell-parser", "session", "resident-dispatch", "performance"],
                commands: [
                    ...
                    { label: "hook-session-snapshot", argv: ["cargo", "test", "-p", "agent-semantic-hook", "--test", "unit_test", "generic_wrapper_testing_resident_dispatch_matches_git_snapshot", "--", "--nocapture"] },
