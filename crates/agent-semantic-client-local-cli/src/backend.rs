...
impl LocalNativeCliBackend {
    ...
    fn provider_command_receipt(
        ...
        ProviderCommandReceipt {
            ...
            stdout_sha256: receipt.stdout_sha256().map(ToOwned::to_owned),
            stderr_sha256: receipt.stderr_sha256().map(ToOwned::to_owned),
            ...
            termination_reason: Some(receipt.termination_reason().to_owned()),
