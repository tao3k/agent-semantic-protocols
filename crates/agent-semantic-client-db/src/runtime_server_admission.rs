...
mod query_demand;
#[path = "runtime_server_admission_receipt.rs"]
mod receipt;
...
pub type WorkspaceGenerationReadyValidator = Arc<
    dyn Fn(&str, &std::path::Path, &WorkspaceGenerationAdmissionReceipt) -> Result<(), String>
        + Send
        + Sync
        + 'static,
>;
