    ...
    json!({
        ...
        "graph": {
            "nodes": [
                ...
                {"id": "owner:1", "kind": "owner", "role": "path", "value": "crates/agent-semantic-client/src/command/graph.rs", "action": "owner"},
                {"id": "owner:2", "kind": "owner", "role": "path", "value": "crates/agent-semantic-client/src/command/search_pipe_graph_turbo.rs", "action": "owner"},
                {"id": "owner:3", "kind": "owner", "role": "path", "value": "crates/agent-semantic-client/src/command/search_pipe_graph_nodes.rs", "action": "owner"},
