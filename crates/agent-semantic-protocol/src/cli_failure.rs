...
pub fn materialize_cli_failure(message: &str) -> String {
    ...
    serde_json::json!({
        ...
        "recovery": "Repair the Host sandbox/process/IPC permission and rerun the exact ASP command. ASP_NO_AGENT bypasses Hook policy only; it cannot override OS permissions.",
