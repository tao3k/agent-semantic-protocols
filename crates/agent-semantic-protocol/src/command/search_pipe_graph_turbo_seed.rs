//! Query-owner seed selection for graph-turbo request packets.
...
fn owner_seed_evidence(candidates: &[Candidate]) -> HashMap<String, OwnerSeedEvidence> {
...
fn is_path_only_evidence(candidate: &Candidate) -> bool {
    matches!(
