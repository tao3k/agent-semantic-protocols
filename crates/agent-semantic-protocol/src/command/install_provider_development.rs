...
use super::provider_install_registry::ProviderInstallArtifactDomain;
...
pub(super) fn capture_development_artifact_provenance(
    dev_root: &Path,
    registration: &super::provider_install_registry::ProviderInstallRegistration,
    target: &str,
    ...
    let provider_digest =
        super::provider_install_registry::provider_install_registration_digest(registration)?;
