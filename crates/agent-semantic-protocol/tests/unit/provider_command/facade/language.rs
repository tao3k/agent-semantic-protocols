...
use crate::provider_command::support::{
    provider, temp_project_root, write_activation, write_echo_provider, write_pwd_provider,
};
...
fn language_facade_uses_nested_package_root_when_child_has_manifest() {
    ...
    let expected_cache_root = child_dir.join(".cache/agent-semantic-protocol/client");
