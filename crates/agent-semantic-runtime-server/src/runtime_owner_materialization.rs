    ...
    > {
        ...
        registry
            .publish_resident_owner_topology_rebind(
                workspace_identity.to_owned(),
                project_root,
                agent_semantic_client_db::runtime_server_workspace::WorkspaceOwnerTopologyRebindV1 {
                    schema_id: agent_semantic_client_db::runtime_server_workspace::WORKSPACE_OWNER_TOPOLOGY_REBIND_SCHEMA_ID.to_owned(),
                    schema_version: "1".to_owned(),
                    rebind_id: format!("{request_id}:owner-topology-rebind"),
