...
/// Repository-local activation generated by `semantic-agent-hook install`.
...
impl ActivatedProvider {
    ...
    pub(crate) fn route_from_template(
        ...
        let argv: Vec<String> = template
            ...
            .collect();
        let argv = if !self.provider_command_prefix.is_empty()
            && argv.first().is_some_and(|command| command == &self.binary)
        {
