...
pub const HOOK_ACTIVATION_SCHEMA_ID: &str =
    "agent.semantic-protocols.semantic-agent-hook-activation";
...
pub const PROVIDER_MANIFEST_SCHEMA_ID: &str =
    "agent.semantic-protocols.semantic-agent-hook-provider-manifest";
