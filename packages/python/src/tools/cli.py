    ...
    def run(self, argv: Sequence[str]) -> int:
        ...
        if self.argv_mode == "argv":
            ...
            if argv:
                ...
                return 2
            result = function()
        else:  # pragma: no cover - typing keeps this unreachable.
