...
namespace ASPProof.CollaborationAgentProjectionDispatch
...
theorem stale_agent_binding_cannot_authorize_dispatch :
    dispatchAdmitted explorerSpec codexExplorerProjection codexPublication
...
end ASPProof.CollaborationAgentProjectionDispatch
