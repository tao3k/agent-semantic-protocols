...
pub(super) fn owner_content_mutation_scenario() -> AspRustProjectHarnessScenario {
    crate::asp_rust_project_harness_scenario!(
        ...
        description: "One edited owner atomically advances content identity and GREP/path coverage, tombstones stale parser-native topology, then one V1 topology rebind publishes exact-selector and Tantivy topology views together without rebuilding the workspace generation.",
