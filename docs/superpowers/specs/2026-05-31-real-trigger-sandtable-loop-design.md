...
`docs/10-19-rfcs/10.05-interactive-graph-first-progressive-searchloop.org` owns the public search workflow language. It
...
1. Update `docs/10-19-rfcs/10.05-interactive-graph-first-progressive-searchloop.org` with the real-trigger loop.
