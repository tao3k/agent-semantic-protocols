...
def test_receipt_separates_composite_search_from_sub_millisecond_exact_reads() -> None:
    ...
    assert {
        ...
        "searchResponseDecodeElapsedMicros",
        "searchPacketBytes",
        "searchNodeCount",
        "searchEdgeCount",
        "searchFrontierCount",
        "searchCoverageCertificateCount",
        "composedSearchOperationId",
        "composedSearchElapsedMicros",
        "composedSearchResponseDecodeElapsedMicros",
        "composedSearchPacketBytes",
        "composedSearchNodeCount",
        "composedSearchEdgeCount",
        "composedSearchFrontierCount",
        "composedSearchCoverageCertificateCount",
        "composedCandidateCount",
        "composedSelectorCount",
        "composedSourceQueryOperationId",
        "composedSourceQueryElapsedMicros",
        "composedCallableSkeletonOperationId",
        "composedCallableSkeletonElapsedMicros",
